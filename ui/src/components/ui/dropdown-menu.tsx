  ...
  ({ className, align = 'center', children, ...props }, ref) => {
    ...
    return (
      <div
        ...
        className={cn(
          'absolute z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md animate-in fade-in-0 zoom-in-95 top-full mt-1',
          alignClass,
          className
        )}
        {...props}
